...
export const catalogSeedProducts: CatalogProduct[] = [
  ...
  product({ id: "mokador-100-arabica-bio", slug: "mokador-100-arabica-bio", sku: "[PENDIENTE DEFINIR SKU]", categorySlug: "cafe-grano", name: "Mokador 100% Arabica Bio", shortDescription: "Mokador 100% Arabica Bio. [PENDIENTE DEFINIR PRECIO] [PENDIENTE DEFINIR SKU]", longDescription: "Producto agregado al catálogo en la categoría café en grano. [PENDIENTE COMPLETAR DESCRIPCION] [PENDIENTE CARGAR IMAGEN]", netPriceClp: 0, image: "/catalog/cutouts/placeholders/mokador-100-arabica-bio.svg", availabilityStatus: "sold_out", sortOrder: 30, highlights: ["[PENDIENTE DEFINIR PRECIO]", "[PENDIENTE DEFINIR SKU]", "[PENDIENTE CARGAR IMAGEN]"] }),
  ...
  product({ id: "mokador-brio-100", slug: "mokador-brio-100", sku: "[PENDIENTE DEFINIR SKU]", categorySlug: "cafe-grano", name: "Mokador Brio 100", shortDescription: "Mokador Brio 100. [PENDIENTE DEFINIR PRECIO] [PENDIENTE DEFINIR SKU]", longDescription: "Producto agregado al catálogo en la categoría café en grano. [PENDIENTE COMPLETAR DESCRIPCION] [PENDIENTE CARGAR IMAGEN]", netPriceClp: 0, image: "/catalog/cutouts/placeholders/mokador-brio-100.svg", availabilityStatus: "sold_out", sortOrder: 32, highlights: ["[PENDIENTE DEFINIR PRECIO]", "[PENDIENTE DEFINIR SKU]", "[PENDIENTE CARGAR IMAGEN]"] }),
  product({ id: "mokador-extra-cream", slug: "mokador-extra-cream", sku: "[PENDIENTE DEFINIR SKU]", categorySlug: "cafe-grano", name: "Mokador Extra Cream", shortDescription: "Mokador Extra Cream. [PENDIENTE DEFINIR PRECIO] [PENDIENTE DEFINIR SKU]", longDescription: "Producto agregado al catálogo en la categoría café en grano. [PENDIENTE COMPLETAR DESCRIPCION] [PENDIENTE CARGAR IMAGEN]", netPriceClp: 0, image: "/catalog/cutouts/placeholders/mokador-extra-cream.svg", availabilityStatus: "sold_out", sortOrder: 33, highlights: ["[PENDIENTE DEFINIR PRECIO]", "[PENDIENTE DEFINIR SKU]", "[PENDIENTE CARGAR IMAGEN]"] }),
  product({ id: "schoppe-caramel-302", slug: "schoppe-caramel-302", sku: "[PENDIENTE DEFINIR SKU]", categorySlug: "cafe-instantaneo", name: "Schoppe Caramel 302", shortDescription: "Schoppe Caramel 302. [PENDIENTE DEFINIR PRECIO] [PENDIENTE DEFINIR SKU]", longDescription: "Producto agregado al catálogo en la categoría café instantáneo. [PENDIENTE COMPLETAR DESCRIPCION] [PENDIENTE CARGAR IMAGEN]", netPriceClp: 0, image: "/catalog/cutouts/placeholders/schoppe-caramel-302.svg", availabilityStatus: "sold_out", sortOrder: 34, highlights: ["[PENDIENTE DEFINIR PRECIO]", "[PENDIENTE DEFINIR SKU]", "[PENDIENTE CARGAR IMAGEN]"] }),
  product({ id: "schoppe-vainilla-301", slug: "schoppe-vainilla-301", sku: "[PENDIENTE DEFINIR SKU]", categorySlug: "cafe-instantaneo", name: "Schoppe Vainilla 301", shortDescription: "Schoppe Vainilla 301. [PENDIENTE DEFINIR PRECIO] [PENDIENTE DEFINIR SKU]", longDescription: "Producto agregado al catálogo en la categoría café instantáneo. [PENDIENTE COMPLETAR DESCRIPCION] [PENDIENTE CARGAR IMAGEN]", netPriceClp: 0, image: "/catalog/cutouts/placeholders/schoppe-vainilla-301.svg", availabilityStatus: "sold_out", sortOrder: 35, highlights: ["[PENDIENTE DEFINIR PRECIO]", "[PENDIENTE DEFINIR SKU]", "[PENDIENTE CARGAR IMAGEN]"] }),
  product({ id: "schoppe-noisete-303", slug: "schoppe-noisete-303", sku: "[PENDIENTE DEFINIR SKU]", categorySlug: "cafe-instantaneo", name: "Schoppe Noisete 303", shortDescription: "Schoppe Noisete 303. [PENDIENTE DEFINIR PRECIO] [PENDIENTE DEFINIR SKU]", longDescription: "Producto agregado al catálogo en la categoría café instantáneo. [PENDIENTE COMPLETAR DESCRIPCION] [PENDIENTE CARGAR IMAGEN]", netPriceClp: 0, image: "/catalog/cutouts/placeholders/schoppe-noisete-303.svg", availabilityStatus: "sold_out", sortOrder: 36, highlights: ["[PENDIENTE DEFINIR PRECIO]", "[PENDIENTE DEFINIR SKU]", "[PENDIENTE CARGAR IMAGEN]"] }),
  product({ id: "schoppe-choco-107", slug: "schoppe-choco-107", sku: "[PENDIENTE DEFINIR SKU]", categorySlug: "cafe-instantaneo", name: "Schoppe Choco 107", shortDescription: "Schoppe Choco 107. [PENDIENTE DEFINIR PRECIO] [PENDIENTE DEFINIR SKU]", longDescription: "Producto agregado al catálogo en la categoría café instantáneo. [PENDIENTE COMPLETAR DESCRIPCION] [PENDIENTE CARGAR IMAGEN]", netPriceClp: 0, image: "/catalog/cutouts/placeholders/schoppe-choco-107.svg", availabilityStatus: "sold_out", sortOrder: 37, highlights: ["[PENDIENTE DEFINIR PRECIO]", "[PENDIENTE DEFINIR SKU]", "[PENDIENTE CARGAR IMAGEN]"] }),
  product({ id: "schoppe-instant-tea-505", slug: "schoppe-instant-tea-505", sku: "[PENDIENTE DEFINIR SKU]", categorySlug: "cafe-instantaneo", name: "Schoppe Instant Tea 505", shortDescription: "Schoppe Instant Tea 505. [PENDIENTE DEFINIR PRECIO] [PENDIENTE DEFINIR SKU]", longDescription: "Producto agregado al catálogo en la categoría café instantáneo. [PENDIENTE COMPLETAR DESCRIPCION] [PENDIENTE CARGAR IMAGEN]", netPriceClp: 0, image: "/catalog/cutouts/placeholders/schoppe-instant-tea-505.svg", availabilityStatus: "sold_out", sortOrder: 38, highlights: ["[PENDIENTE DEFINIR PRECIO]", "[PENDIENTE DEFINIR SKU]", "[PENDIENTE CARGAR IMAGEN]"] }),
  ...
  product({ id: "laqtia-natur-basic", slug: "laqtia-natur-basic", sku: "[PENDIENTE DEFINIR SKU]", categorySlug: "cafe-instantaneo", name: "Laqtia Natur Basic", shortDescription: "Laqtia Natur Basic. [PENDIENTE DEFINIR PRECIO] [PENDIENTE DEFINIR SKU]", longDescription: "Producto agregado al catálogo en la categoría café instantáneo. [PENDIENTE COMPLETAR DESCRIPCION] [PENDIENTE CARGAR IMAGEN]", netPriceClp: 0, image: "/catalog/cutouts/placeholders/laqtia-natur-basic.svg", availabilityStatus: "sold_out", sortOrder: 44, highlights: ["[PENDIENTE DEFINIR PRECIO]", "[PENDIENTE DEFINIR SKU]", "[PENDIENTE CARGAR IMAGEN]"] }),
];
