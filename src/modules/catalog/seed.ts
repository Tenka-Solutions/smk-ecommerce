...
export const catalogSeedProducts: CatalogProduct[] = [
  ...
  product({ id: "mokador-100-arabica-bio", slug: "mokador-100-arabica-bio", sku: "[PENDIENTE DEFINIR SKU]", categorySlug: "cafe-grano", name: "Mokador 100% Arabica Bio", shortDescription: "Mokador 100% Arabica Bio. [PENDIENTE DEFINIR PRECIO] [PENDIENTE DEFINIR SKU]", longDescription: "Producto agregado al catálogo en la categoría café en grano. [PENDIENTE COMPLETAR DESCRIPCION] [PENDIENTE CARGAR IMAGEN]", netPriceClp: 0, image: "/catalog/cutouts/placeholders/arabicabio.png", availabilityStatus: "sold_out", sortOrder: 30, highlights: ["[PENDIENTE DEFINIR PRECIO]", "[PENDIENTE DEFINIR SKU]", "[PENDIENTE CARGAR IMAGEN]"] }),
