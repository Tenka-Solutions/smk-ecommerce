...
const badgeStyles: Record<CatalogProduct["availabilityStatus"], string> = {
  available:
    "bg-[color-mix(in_srgb,var(--color-success)_14%,var(--card)_86%)] text-[var(--color-success)]",
  check_availability:
    "bg-[color-mix(in_srgb,var(--color-warning)_14%,var(--card)_86%)] text-[var(--color-warning)]",
  sold_out:
    "bg-[color-mix(in_srgb,var(--color-danger)_14%,var(--card)_86%)] text-[var(--color-danger)]",
};
