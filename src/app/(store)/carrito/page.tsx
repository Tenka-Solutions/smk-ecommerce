  ...
  return (
    <div className="page-shell py-6 pb-32 sm:py-10 xl:pb-10">
      ...
      {hasHydrated && items.length ? (
        <div className="fixed inset-x-0 bottom-0 z-40 border-t border-[var(--color-border)] bg-[color-mix(in_srgb,var(--color-card)_96%,transparent)] px-4 py-4 shadow-[0_-18px_40px_-28px_rgba(29,26,23,0.35)] backdrop-blur lg:hidden">
