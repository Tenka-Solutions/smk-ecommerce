...
values
  ...
  ('mokador-100-arabica-bio', 'cat-grano', 'Mokador 100% Arabica Bio', 'mokador-100-arabica-bio', '[PENDIENTE DEFINIR SKU]', 'Mokador 100% Arabica Bio. [PENDIENTE DEFINIR PRECIO] [PENDIENTE DEFINIR SKU]', 'Producto agregado al catalogo en la categoria cafe en grano. [PENDIENTE COMPLETAR DESCRIPCION]', 0, 'sold_out', 'published', false, 30, 'Mokador 100% Arabica Bio | SMK Vending', 'Mokador 100% Arabica Bio. [PENDIENTE DEFINIR PRECIO] [PENDIENTE DEFINIR SKU]', '/catalog/cutouts/arabicabio.png'),
  ...
  ('mokador-brio-100', 'cat-grano', 'Mokador Brio 100', 'mokador-brio-100', '[PENDIENTE DEFINIR SKU]', 'Mokador Brio 100. [PENDIENTE DEFINIR PRECIO] [PENDIENTE DEFINIR SKU]', 'Producto agregado al catalogo en la categoria cafe en grano. [PENDIENTE COMPLETAR DESCRIPCION]', 0, 'sold_out', 'published', false, 32, 'Mokador Brio 100 | SMK Vending', 'Mokador Brio 100. [PENDIENTE DEFINIR PRECIO] [PENDIENTE DEFINIR SKU]', '/catalog/cutouts/brio.png'),
  ('mokador-extra-cream', 'cat-grano', 'Mokador Extra Cream', 'mokador-extra-cream', '[PENDIENTE DEFINIR SKU]', 'Mokador Extra Cream. [PENDIENTE DEFINIR PRECIO] [PENDIENTE DEFINIR SKU]', 'Producto agregado al catalogo en la categoria cafe en grano. [PENDIENTE COMPLETAR DESCRIPCION]', 0, 'sold_out', 'published', false, 33, 'Mokador Extra Cream | SMK Vending', 'Mokador Extra Cream. [PENDIENTE DEFINIR PRECIO] [PENDIENTE DEFINIR SKU]', '/catalog/cutouts/extracream.png'),
  ('schoppe-caramel-302', 'cat-instantaneo', 'Schoppe Caramel 302', 'schoppe-caramel-302', '[PENDIENTE DEFINIR SKU]', 'Schoppe Caramel 302. [PENDIENTE DEFINIR PRECIO] [PENDIENTE DEFINIR SKU]', 'Producto agregado al catalogo en la categoria cafe instantaneo. [PENDIENTE COMPLETAR DESCRIPCION]', 0, 'sold_out', 'published', false, 34, 'Schoppe Caramel 302 | SMK Vending', 'Schoppe Caramel 302. [PENDIENTE DEFINIR PRECIO] [PENDIENTE DEFINIR SKU]', '/catalog/cutouts/302.png'),
  ('schoppe-vainilla-301', 'cat-instantaneo', 'Schoppe Vainilla 301', 'schoppe-vainilla-301', '[PENDIENTE DEFINIR SKU]', 'Schoppe Vainilla 301. [PENDIENTE DEFINIR PRECIO] [PENDIENTE DEFINIR SKU]', 'Producto agregado al catalogo en la categoria cafe instantaneo. [PENDIENTE COMPLETAR DESCRIPCION]', 0, 'sold_out', 'published', false, 35, 'Schoppe Vainilla 301 | SMK Vending', 'Schoppe Vainilla 301. [PENDIENTE DEFINIR PRECIO] [PENDIENTE DEFINIR SKU]', '/catalog/cutouts/301.svg'),
  ('schoppe-noisete-303', 'cat-instantaneo', 'Schoppe Noisete 303', 'schoppe-noisete-303', '[PENDIENTE DEFINIR SKU]', 'Schoppe Noisete 303. [PENDIENTE DEFINIR PRECIO] [PENDIENTE DEFINIR SKU]', 'Producto agregado al catalogo en la categoria cafe instantaneo. [PENDIENTE COMPLETAR DESCRIPCION]', 0, 'sold_out', 'published', false, 36, 'Schoppe Noisete 303 | SMK Vending', 'Schoppe Noisete 303. [PENDIENTE DEFINIR PRECIO] [PENDIENTE DEFINIR SKU]', '/catalog/cutouts/303.svg'),
  ('schoppe-choco-107', 'cat-instantaneo', 'Schoppe Choco 107', 'schoppe-choco-107', '[PENDIENTE DEFINIR SKU]', 'Schoppe Choco 107. [PENDIENTE DEFINIR PRECIO] [PENDIENTE DEFINIR SKU]', 'Producto agregado al catalogo en la categoria cafe instantaneo. [PENDIENTE COMPLETAR DESCRIPCION]', 0, 'sold_out', 'published', false, 37, 'Schoppe Choco 107 | SMK Vending', 'Schoppe Choco 107. [PENDIENTE DEFINIR PRECIO] [PENDIENTE DEFINIR SKU]', '/catalog/cutouts/107.png'),
  ('schoppe-instant-tea-505', 'cat-instantaneo', 'Schoppe Instant Tea 505', 'schoppe-instant-tea-505', '[PENDIENTE DEFINIR SKU]', 'Schoppe Instant Tea 505. [PENDIENTE DEFINIR PRECIO] [PENDIENTE DEFINIR SKU]', 'Producto agregado al catalogo en la categoria cafe instantaneo. [PENDIENTE COMPLETAR DESCRIPCION]', 0, 'sold_out', 'published', false, 38, 'Schoppe Instant Tea 505 | SMK Vending', 'Schoppe Instant Tea 505. [PENDIENTE DEFINIR PRECIO] [PENDIENTE DEFINIR SKU]', '/catalog/cutouts/505.svg'),
  ...
  ('laqtia-natur-basic', 'cat-instantaneo', 'Laqtia Natur Basic', 'laqtia-natur-basic', '[PENDIENTE DEFINIR SKU]', 'Laqtia Natur Basic. [PENDIENTE DEFINIR PRECIO] [PENDIENTE DEFINIR SKU]', 'Producto agregado al catalogo en la categoria cafe instantaneo. [PENDIENTE COMPLETAR DESCRIPCION]', 0, 'sold_out', 'published', false, 44, 'Laqtia Natur Basic | SMK Vending', 'Laqtia Natur Basic. [PENDIENTE DEFINIR PRECIO] [PENDIENTE DEFINIR SKU]', '/catalog/cutouts/laqtia-natur-basic.png')
on conflict (id) do update
set
