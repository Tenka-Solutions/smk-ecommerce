...
values
  ...
  ('mokador-100-arabica-bio', 'cat-grano', 'Mokador 100% Arabica Bio', 'mokador-100-arabica-bio', '[PENDIENTE DEFINIR SKU]', 'Mokador 100% Arabica Bio. [PENDIENTE DEFINIR PRECIO] [PENDIENTE DEFINIR SKU]', 'Producto agregado al catalogo en la categoria cafe en grano. [PENDIENTE COMPLETAR DESCRIPCION] [PENDIENTE CARGAR IMAGEN]', 0, 'sold_out', 'published', false, 30, 'Mokador 100% Arabica Bio | SMK Vending', 'Mokador 100% Arabica Bio. [PENDIENTE DEFINIR PRECIO] [PENDIENTE DEFINIR SKU]', '/catalog/cutouts/placeholders/arabicabio.png'),
